	...
	public class DefiledShrineGump : Gump
	{
		...
		private static DefiledRewardCategory[] Categories = new DefiledRewardCategory[]
		{
			...
			new DefiledRewardCategory( "Leather",
				...
				new DefiledRewardEntry( 5054, "leather legs", 50, typeof( LeatherLegs ) ),
				new DefiledRewardEntry( 5054, "leather arms", 50, typeof( LeatherArms ) ),
				new DefiledRewardEntry( 5054, "leather gloves", 50, typeof( LeatherGloves ) ) ),
